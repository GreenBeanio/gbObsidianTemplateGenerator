...
- template_dir:
  ...
  A directory with the "Day.md" template file to process (Default:
...
- template_pre:
  ...
  An optional prefix on your "Day.md" file to use a different template
  (Default: "")
...
A list with the Day of the week as the key and the path to the exported
file as the value.
