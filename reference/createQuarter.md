...
- template_dir:
  ...
  A directory with the "Quarter.md" template file to process (Default:
...
- template_pre:
  ...
  An optional prefix on your "Quarter.md" file to use a different
  template (Default: "")
...
A list with the Quarter of the year as the key and the path to the
