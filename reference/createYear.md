...
- template_dir:
  ...
  A directory with the "Year.md" template file to process (Default:
...
- template_pre:
  ...
  An optional prefix on your "Year.md" file to use a different template
  (Default: "")
...
A list with the Year as the key and the path to the exported file as the
value.
